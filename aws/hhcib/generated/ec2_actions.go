...
type AssignPrivateIpAddresses struct {
	...
	SecondaryPrivateIpAddressCount int `aws:"SecondaryPrivateIpAddressCount"`
	AllowReassignment bool `aws:"AllowReassignment"`
}
...
type AssociateAddress struct {
	...
	AllowReassociation bool `aws:"AllowReassociation"`
}
...
type AttachNetworkInterface struct {
	NetworkInterfaceId string `aws:"NetworkInterfaceId"`
	InstanceId string `aws:"InstanceId"`
	DeviceIndex int `aws:"DeviceIndex"`
}
...
type CreateNetworkAclEntry struct {
	...
	RuleNumber int `aws:"RuleNumber"`
	Protocol int `aws:"Protocol"`
	RuleAction string `aws:"RuleAction"`
	Egress bool `aws:"Egress"`
	CidrBlock string `aws:"CidrBlock"`
	IcmpCode int `aws:"Icmp.Code"`
	IcmpType int `aws:"Icmp.Type"`
	PortRangeFrom int `aws:"PortRange.From"`
	PortRangeTo int `aws:"PortRange.To"`
}
...
type CreateReservedInstancesListing struct {
	...
	InstanceCount int `aws:"instanceCount"`
...
type CreateVpnConnection struct {
	...
	VpnGatewayId string `aws:"VpnGatewayId"`
	OptionsStaticRoutesOnly bool `aws:"Options.StaticRoutesOnly"`
}
...
type  DescribeInstanceStatus  struct {
	InstanceId string `aws:"InstanceId"`
	IncludeAllInstances bool `aws:"IncludeAllInstances"`
	MaxResults int `aws:"MaxResults"`
	NextToken string `aws:"NextToken"`
	Filters []*Filter `aws:"Filter"`
}
...
type DescribeReservedInstancesOfferings struct {
	...
	InstanceTenancy string `aws:"InstanceTenancy"`
	OfferingType string `aws:"OfferingType"`
	IncludeMarketplace bool `aws:"IncludeMarketplace"`
	MinDuration int `aws:"MinDuration"`
	MaxDuration int `aws:"MaxDuration"`
	MaxInstanceCount int `aws:"MaxInstanceCount"`
	NextToken string `aws:"NextToken"`
	MaxResults int `aws:"MaxResults"`
	Filters []*Filter `aws:"Filter"`
}
...
type ImportInstance struct {
	...
	LaunchSpecificationMonitoringEnabled bool `aws:"LaunchSpecification.Monitoring.Enabled"`
...
type ImportVolume struct {
	...
	ImageBytes int `aws:"Image.Bytes"`
	ImageImportManifestUrl string `aws:"Image.ImportManifestUrl"`
	Description string `aws:"Description"`
	VolumeSize int `aws:"Volume.Size"`
}
...
type ModifyInstanceAttribute struct {
	...
	DisableApiTerminationValue bool `aws:"DisableApiTermination.Value"`
	EbsOptimized bool `aws:"EbsOptimized"`
	GroupIds []string `aws:"GroupId"`
	...
	SourceDestCheckValue bool `aws:"SourceDestCheck.Value"`
...
type ModifyNetworkInterfaceAttribute struct {
	...
	AttachmentDeleteOnTermination bool `aws:"Attachment.DeleteOnTermination"`
}
...
type ModifyVolumeAttribute struct {
	VolumeId string `aws:"VolumeId"`
	AutoEnableIOValue bool `aws:"AutoEnableIO.Value"`
}

type ModifyVpcAttribute struct {
	VpcId string `aws:"VpcId"`
	EnableDnsSupport bool `aws:"enableDnsSupport"`
	EnableDnsHostnames bool `aws:"enableDnsHostnames"`
}
...
type RequestSpotInstances struct {
	...
	LaunchSpecificationEbsOptimized bool `aws:"LaunchSpecification.EbsOptimized"`
...
type RunInstances struct {
	ImageId string `aws:"ImageId"`
	MinCount int `aws:"MinCount"`
	MaxCount int `aws:"MaxCount"`
	KeyName string `aws:"KeyName"`
	SecurityGroupIds []string `aws:"SecurityGroupId"`
	...
	KernelId string `aws:"KernelId"`
	RamdiskId string `aws:"RamdiskId"`
	MonitoringEnabled bool `aws:"Monitoring.Enabled"`
	SubnetId string `aws:"SubnetId"`
	DisableApiTermination bool `aws:"DisableApiTermination"`
...
type LaunchSpecificationBlockDeviceMapping struct {
	...
	NoDevice bool `aws:"NoDevice"`
	VirtualName string `aws:"VirtualName"`
	EbsSnapshotId string `aws:"Ebs.SnapshotId"`
	EbsVolumeSize int `aws:"Ebs.VolumeSize"`
	EbsDeleteOnTermination bool `aws:"Ebs.DeleteOnTermination"`
	EbsVolumeType string `aws:"Ebs.VolumeType"`
	EbsIops int `aws:"Ebs.Iops"`
}

type IpPermissions struct {
	IpProtocol string `aws:"IpProtocol"`
	FromPort int `aws:"FromPort"`
	ToPort int `aws:"ToPort"`
	GroupsmGroupName string `aws:"Groups.m.GroupName "`
	GroupsmGroupId string `aws:"Groups.m.GroupId "`
	GroupsmUserId string `aws:"Groups.m.UserId "`
	IpRangesmCidrIp string `aws:"IpRanges.m.CidrIp"`
}
...
type NetworkInterface struct {
	DeviceIndex int `aws:"DeviceIndex"`
	PrivateIpAddress string `aws:"PrivateIpAddress"`
	DeleteOnTermination bool `aws:"DeleteOnTermination"`
	SecondaryPrivateIpAddressCount struct{} `aws:"SecondaryPrivateIpAddressCount"`
	NetworkInterfaceId string `aws:"NetworkInterfaceId"`
	SubnetId string `aws:"SubnetId"`
	Description string `aws:"Description"`
	PrivateIpAddresses bool `aws:"PrivateIpAddresses"`
	AssociatePublicIpAddress bool `aws:"AssociatePublicIpAddress"`
}
